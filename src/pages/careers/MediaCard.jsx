...
import { AccessTime, Business, CurrencyYen, Place, Work } from "@mui/icons-material"
    ...
    return (
      ...
      <Card sx={{ maxWidth: 345, "&:hover":{boxShadow:"rgba(0, 0, 0, 0.35) 0px 5px 15px"}}}>
        ...
        <CardContent  >
          ...
          <Typography sx={{color:"gray", margin:"5px"}}><Work fontSize="small"/></Typography>
          <Typography variant="h3" sx={{fontSize:"25px"}}>
            {career.occupation_title}
          </Typography>
          </Box>
          <Box sx={{display:"flex", gap:"30px",  alignContent:"center"}}>
          <Typography sx={{color:"gray", margin:"5px"}}><Business fontSize="small"/></Typography>
          <Typography sx={{color:"gray", fontSize:"20px"}} > 
           {career.company_name}
          </Typography>
          </Box>
          <Box sx={{display:"flex", gap:"30px", alignContent:"center"}}>
          <Typography sx={{color:"gray", margin:"5px"}}><AccessTime fontSize="small"/></Typography>
          <Typography sx={{color:"gray"}} > 
           {career.job_type}
          </Typography>
          </Box>
          <Box sx={{display:"flex", gap:"30px",  alignContent:"center"}}>
          <Typography sx={{color:"gray", margin:"5px"}}><CurrencyYen fontSize="small"/></Typography>
          <Typography sx={{color:"gray"}} >
            {career.salary} / hr
          </Typography>
          </Box>
          <Box sx={{display:"flex", gap:"30px",  alignContent:"center"}}>
          <Typography sx={{color:"gray", margin:"5px"}}><Place fontSize="small"/></Typography>
          <Typography sx={{color:"gray"}} >
            {career.location}
          </Typography>
          </Box> 
