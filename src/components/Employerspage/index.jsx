    ...
    <>
      ...
      >
        ...
        <Box>
          ...
          <Box mb="50px" data-aos="fade-down" data-aos-duration="500">
      ...
      >
        ...
        <Box data-aos="fade-right" data-aos-duration="500">
          ...
          <StyledTypography>
            実務経験ルートでは、3年以上の経験（従業期間3年以上、従事日数540日以上）と合わせて実務者研修の修了が国家試験受験の際の条件
          </StyledTypography>
          <StyledTypography>
        ...
        <Box data-aos="fade-up" data-aos-duration="500">
          ...
          <StyledTypography>
            450時間のカリキュラム修了するには、民間の資格学校に通って講座を受講。
          </StyledTypography>
          <StyledTypography>
            スクールは多数あるため、スクーリングや通信教育形式など、自分に合った学び方を選べる。
          </StyledTypography>
          ...
          <StyledTypography>
            通信講座と実技必要。土・日コース5ヶ月ほど
          </StyledTypography>
          <StyledTypography>
            1度取ると一生有効。更新なし。訪問介護や夜勤もできる。
          </StyledTypography>
          <StyledTypography>
            外国人の方においては、講義や試験が日本語で行われるので、日本語能力試験のN4レベル相当の理解力が必要。
          </StyledTypography>
          <StyledTypography>
            130時間。スクーリング15日間程度 10:00～18:00
          </StyledTypography>
