  ...
  return (
    ...
    <Box sx={{marginTop:"50px"}}>
      ...
      <Box  sx={{
        ...
        <Typography ml="20px" mb="10px" >倉庫作業員は、注文や製品を保管および処理するビジネスの不可欠な部分である専門家です。 彼らは、入荷した在庫の受け取りと処理、倉庫在庫からの注文のピッキングと管理を監督します。</Typography>
        <Typography fontWeight="bold" ml="20px">倉庫作業員の責任には以下が含まれます。</Typography>
        <Box ml="30px">
        <Typography> 🔘スケジュールに従って配送または集荷するための倉庫注文の準備と完了</Typography>
        <Typography>🔘倉庫在庫商品の受取り・加工</Typography>
        <Typography>🔘倉庫の在庫管理を実施し、監査のために高い品質基準を維持します。</Typography>
        </Box>
      </Box>
      <Box  sx={{
          margin: { md: "50px 0px", xs: "20px 0", sm: "30px 0" },
